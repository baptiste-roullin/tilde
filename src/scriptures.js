...
const visitor = [
	"premier",
	"second",
	"quarante-deuxième et demi",
	"trois-cent million quatre-vingt-quinze-ième",
	"dernier",
]
const browser = [
	"Beaker",
...
const ame = [
	"orange mat",
	"cristalline",
	"a un arrière-goût de métal",
	"étincèle dans les logs de mon serveur",
]
